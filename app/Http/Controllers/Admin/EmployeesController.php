...
class EmployeesController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $table->editColumn('look', function ($row) {
                return $row->look ? $row->look : "";
            });
            $table->editColumn('situation_familiale', function ($row) {
                return $row->situation_familiale ? $row->situation_familiale : "";
            });
            $table->editColumn('langue', function ($row) {
                return $row->langue ? $row->langue : "";
            });
            $table->editColumn('experience', function ($row) {
                return $row->experience ? $row->experience : "";
            });
            $table->editColumn('nombre_heure', function ($row) {
                return $row->nombre_heure ? $row->nombre_heure : "";
            });
            $table->editColumn('salaire', function ($row) {
                return $row->salaire ? $row->salaire : "";
            });
