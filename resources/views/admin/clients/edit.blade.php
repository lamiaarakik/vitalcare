...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.clients.update", [$client->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('situation_familial') ? 'has-error' : '' }}">
                <label for="situation_familial">id mutuel</label>
                <input type="text" id="situation_familial" name="situation_familial" class="form-control" value="{{ old('situation_familial', isset($client) ? $client->situation_familial : '') }}">
                @if($errors->has('situation_familial'))
                    <em class="invalid-feedback">
                        {{ $errors->first('situation_familial') }}
                    </em>
                @endif
            ...
            <div class="form-group {{ $errors->has('nbr_enfants') ? 'has-error' : '' }}">
                <label for="nbr_enfants">nbr_enfants</label>
                <input type="text" id="nbr_enfants" name="nbr_enfants" class="form-control" value="{{ old('nbr_enfants', isset($client) ? $client->nbr_enfants : '') }}">
            ...
            <div class="form-group {{ $errors->has('telephone_referent') ? 'has-error' : '' }}">
                <label for="telephone_referent">telephone_referent</label>
...
<label for="qui_aide" >              Si oui, qui vous aide ? </label> <input type="text" id="qui_aide" class="form-control" name="qui_aide"  value="{{ old('qui_aide', isset($client) ? $client->qui_aide : '') }}">
            ...
            <div class="form-group {{ $errors->has('habitude_de_vie') ? 'has-error' : '' }}">
                <label for="habitude_de_vie">habitude de vie</label>
                <br> <p>
...
Habitude d’hygiène, de sommeil, alimentaires…
            ...
            <div class="form-group {{ $errors->has('histoire_de_vie') ? 'has-error' : '' }}">
                <label for="histoire_de_vie">histoire de vie</label>
                <br> <p>
